...
<body>
    ...
    <!--Nav bar End-->
        <asp:Label ID="Label1" runat="server" CssClass=" red-text" style="position:center;margin-left:50%;font-size:25px;"></asp:Label>
        <br /> <br />
    ...
    <div class="container">
        <div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=votingdatabase;Integrated Security=True" SelectCommand="SELECT * FROM [elections]"></asp:SqlDataSource>
        </div>
    </div>
       </form>
