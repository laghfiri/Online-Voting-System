...
public partial class RegisterProfessor : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        string insert = "insert into Voters values(@num,@name,@email,@gender,@adr,@mobile,@birthdate,@departement,@grade,@password)";

        SqlCommand cd = new SqlCommand(insert, con);
        cd.Parameters.AddWithValue("@num", number.Value);
        ...
        cd.Parameters.AddWithValue("@departement", DropDownList1.SelectedValue);
